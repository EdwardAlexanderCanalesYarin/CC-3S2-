...
public class Tablero {
    ...
    protected char seleccionAzul;
    protected char seleccionRojo;
    ...
    * y predefine el turno del jugador, por defencto empieza el jugador Azul
    ...
    public void RealizarMovimiento(int filas, int columnas)
    {
        if(CeldaValida(filas,columnas))
        {
            if(turno=='A')
            {
                celdas[filas][columnas] = (seleccionAzul=='S')? ContenidoCeldas.AZUL_S: ContenidoCeldas.AZUL_O;
            }else {
                celdas[filas][columnas]= (seleccionRojo=='S')? ContenidoCeldas.ROJO_S: ContenidoCeldas.ROJO_O;
            }
    ...
    public void setSeleccionAzul(char seleccion){this.seleccionAzul = seleccion;}
    public char getSeleccionAzul(){return seleccionAzul;}
    public void setSeleccionRojo(char seleccion){this.seleccionRojo = seleccion;}
    public char getSeleccionRojo(){return seleccionRojo;}
